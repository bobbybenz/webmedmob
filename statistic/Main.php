      ...
      <div id="page-content-wrapper">
        <div class="container">
          ...
          <div class="row" id="trend-chart-north">
            ...
            <div class="col-md-7">
             <div id="curve_chart2" style="width: 720px; height: 400px"></div>
            </div>
            <div class="col-md-5">
              <h4>Top List</h4>
                    <table class="table">
          ...
          <div class="row" id="trend-chart-north">
            ...
            <div class="col-md-7">
             <div id="curve_chart3" style="width: 720px; height: 400px"></div>
            </div>
            <div class="col-md-5">
              <h4>Top List</h4>
                    <table class="table">
          ...
          <div class="row" id="trend-chart-north">
            ...
            <div class="col-md-7">
             <div id="curve_chart4" style="width: 720px; height: 400px"></div>
            </div>
            <div class="col-md-4">
              <h4>Top List</h4>
                    <table class="table">
          ...
          <div class="row" id="trend-chart-north">
            ...
            <div class="col-md-7">
             <div id="curve_chart5" style="width: 720px; height: 400px"></div>
            </div>
            <div class="col-md-5">
              <h4>Top List</h4>
                    <table class="table">
